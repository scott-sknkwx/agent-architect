...
- What data is available at lead ingestion
...
## Ingestion Pattern (Inngest-first)

See `webhook-routing.md` for full pattern details.
...
Wraps raw payload in Inngest event format:
```javascript
